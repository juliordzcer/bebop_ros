...
class Controller(Node):
    ...
    def __init__(self):
        ...
        self.pid_z = PID(self, 2.0, 1.00, 2.00,-6.0, 6.0, "z")  
        self.pid_yaw = PID(self, 3.00, 0.7, 0.20, -200.0, 200.0, "yaw")  
    ...
    def run(self):
        ...
        if self.state == Controller.Automatic:
            ...
            msg.angular.z = float(self.pid_z.update(0.0, math.degrees(eyaw)))*0.00
