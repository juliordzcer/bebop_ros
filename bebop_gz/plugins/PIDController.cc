 ...
 */
     ...
     EventManager &/*_eventMgr*/)
 {
   ...
   {
     gzerr << "Please specify velocityGain for PIDController.\n";
     return;
   }
   ...
   {
     gzerr << "Please specify attitudeGain for PIDController.\n";
     return;
   }
   ...
   {
     gzerr << "Please specify angularRateGain PIDController.\n";
     return;
   }
